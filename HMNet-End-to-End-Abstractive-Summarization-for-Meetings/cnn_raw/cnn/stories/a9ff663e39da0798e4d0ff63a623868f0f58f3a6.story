(CNN) -- Flying JetBlue Airways? You might have to wait until your flight crew rests up if your travel includes Boston's Logan International Airport or the three New York City-area airports.
...
JetBlue said it is scheduling extra flights to address the backlog and will extend apologies and compensation offers to passengers. Passengers whose flights have been canceled should not go to the airport, the airline said. The airline has compiled its advice to stranded passengers in a blog post, with links to the fee waiver policy and rebooking page.

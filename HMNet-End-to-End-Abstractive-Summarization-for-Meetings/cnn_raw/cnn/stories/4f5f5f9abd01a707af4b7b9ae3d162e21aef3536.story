(CNN) -- Columbia University will welcome back the U.S. Navy and a new class for the Naval Reserve Officers Training Corps on Monday after a more than 40-year absence, according to a news release from the Naval Service Training Command.

...
The Neptune Pine claims to be a standalone device so that the smartwatch will be the only device you'll need — without any attachment to a smartphone. From Pine, you can conduct voice calls and video chat, take pictures, use a built-in GPS, and text via a full keyboard. You can even browse the web with 3G and WiFi.

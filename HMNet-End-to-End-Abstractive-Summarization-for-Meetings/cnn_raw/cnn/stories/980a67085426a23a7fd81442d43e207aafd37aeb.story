New York (CNN) -- A federal jury in New York ruled Tuesday that a man who identifies as black and Hispanic and the nonprofit he founded must pay punitive damages to an African-American employee after a previous ruling that the use of the "n-word" is inappropriate among minorities in a workplace.
...
"This case is most important because this is the first where we essentially have the n-word on trial," said Johnson's attorney, Marjorie Sharpe. "You have heard the connotation that the n-word can have different meanings depending on the speaker; there is an undisguised belief that if the person saying the n-word is black or African-American, somehow it makes it OK.

"There are a number of cases where the n-word has been used in a workplace, but usually it's been done between people of different races, and when we're having that discussion, it seems that it's clear that if you're not African-American and you use the n-word, absolutely it's insulting," Sharpe said.
...
A black employee sues, claiming her black boss used the n-word in a rant against her

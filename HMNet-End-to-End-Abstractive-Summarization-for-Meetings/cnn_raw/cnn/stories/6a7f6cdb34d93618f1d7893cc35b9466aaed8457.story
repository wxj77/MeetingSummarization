...
Netflix raised its prices in response to the expected increase in content pricing from major studios, which the company believed made Netflix's flagship offering, one-DVD-out-at-a-time-plus-unlimited-streamed-content for $9.99, impossible for them to continue. As a result, in July, it announced plans to split the DVD business and the streaming business, charging $7.99 for each. Netflix's goal was to convert current clients from "DVDs and streaming" to "DVDs or streaming" and charging a premium for customers wanting to stay with both.
...
The opinions expressed in this commentary are solely those of Robbie Kellman Baxter.

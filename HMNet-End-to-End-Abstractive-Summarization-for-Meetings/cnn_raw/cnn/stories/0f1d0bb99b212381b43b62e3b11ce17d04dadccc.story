(Mashable)  -- Lady Gaga is the first Twitter user with over 10 million followers, which is a first for both the singer and Twitter itself.
...
This is first for the singer and for Twitter itself
